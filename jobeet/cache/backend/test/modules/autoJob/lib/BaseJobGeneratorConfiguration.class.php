...
abstract class BaseJobGeneratorConfiguration extends sfModelGeneratorConfiguration
{
  ...
  {
    return array(  'extend' => NULL,  '_delete' => NULL,);
  }

  public function getListParams()
  {
    return '%%is_activated%% <small>%%category_id%%</small> - %%company%%(<em>%%email%%</em>) is looking for a %%=position%% (%%location%%)';
  }
  ...
  public function getFieldsDefault()
  {
    return array(
      ...
      'is_activated:{label' => array(  'is_link' => false,  'is_real' => false,  'is_partial' => false,  'is_component' => false,  'type' => 'Text',),
      'is_public:{label' => array(  'is_link' => false,  'is_real' => false,  'is_partial' => false,  'is_component' => false,  'type' => 'Text',),
    );
  }
