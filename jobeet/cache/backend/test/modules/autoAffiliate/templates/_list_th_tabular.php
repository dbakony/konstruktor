...
<th class="sf_admin_boolean sf_admin_list_th_is_active">
  <?php if ('is_active' == $sort[0]): ?>
    <?php echo link_to(__('Is active', array(), 'messages'), '@jobeet_affiliate', array('query_string' => 'sort=is_active&sort_type='.($sort[1] == 'asc' ? 'desc' : 'asc'))) ?>
    <?php echo image_tag(sfConfig::get('sf_admin_module_web_dir').'/images/'.$sort[1].'.png', array('alt' => __($sort[1], array(), 'sf_admin'), 'title' => __($sort[1], array(), 'sf_admin'))) ?>
  <?php else: ?>
    <?php echo link_to(__('Is active', array(), 'messages'), '@jobeet_affiliate', array('query_string' => 'sort=is_active&sort_type=asc')) ?>
  <?php endif; ?>
</th>
<?php end_slot(); ?>
